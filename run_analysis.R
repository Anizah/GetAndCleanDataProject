#################################################################################
# 
#  This assignment create R script named run_analysis.R that does the following: 
#
...
#
#The data of the assignment is based on the UCI HAR Dataset downloaded from 
# https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Data# set.zip 
# The downloded, unzipped and placed in data folder (C:/Users/anizah/data/UCI HAR Dataset)
#
#################################################################################
...
filePath <- file.path("C:/Users/anizah/data", "UCI HAR Dataset")
